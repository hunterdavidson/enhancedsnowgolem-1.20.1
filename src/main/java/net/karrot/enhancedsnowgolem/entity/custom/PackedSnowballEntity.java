...
public class PackedSnowballEntity extends ThrownItemEntity {
    ...
    public PackedSnowballEntity(LivingEntity livingEntity, World world) {
        super(ModEntities.PACKED_SNOWBALL_ENTITY, livingEntity, world);
    }

    @Override
    protected Item getDefaultItem() {
        return ModItems.PACKED_SNOWBALL;
    }
