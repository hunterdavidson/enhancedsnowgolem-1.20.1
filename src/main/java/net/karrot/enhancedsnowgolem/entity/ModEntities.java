...
public class ModEntities {
    ...
    public static final EntityType<PackedSnowballEntity> PACKED_SNOWBALL_ENTITY = Registry.register(Registries.ENTITY_TYPE,
            new Identifier(EnhancedSnowGolem.MOD_ID, "packed_snowball_entity"),
            FabricEntityTypeBuilder.<PackedSnowballEntity>create(SpawnGroup.MISC, PackedSnowballEntity::new)
                    .dimensions(EntityDimensions.fixed(0.25f, 0.25f)).build());

    public static final EntityType<PackedSnowGolemEntity> PACKED_SNOW_GOLEM = Registry.register(Registries.ENTITY_TYPE,
            new Identifier(EnhancedSnowGolem.MOD_ID, "packed_snow_golem"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, PackedSnowGolemEntity::new)
